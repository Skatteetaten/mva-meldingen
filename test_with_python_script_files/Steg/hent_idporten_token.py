...
def get_idtoken():
    client_id = '23cc2587-ea4e-4a5f-aa5c-dfce3d6c5f09'  # gammel: 38e634d9-5682-44ae-9b60-db636efe3156
    ...
    print("Query state length is " + str(len(qs['state'])))
    print("Query state is " + qs['state'][0])
    ...
    assert access_token['acr'] == "Level3" or access_token['acr'] == "Level4"

    token_lifetime = access_token['exp'] - int(time.time())
    print("The token is good, expires in {} seconds".format(token_lifetime))
