...
- XSD for submission of meta data information 
...
The submissing of the VAT return requires an XML file containg metadata. This file must be according to the XSD below.
