...
| 2021.11.02 | Oppdaterte kodelister, lagt til nye gyldige merknader for SAFT mva-koder 81, 1, 11, 12 and 13 i [merknadTilsvarendeMvaKode](https://github.com/Skatteetaten/mva-meldingen/blob/master/docs/documentation/informasjonsmodell/kodelister/merknadTilsvarendeMvaKode.xml), små oppdateringer i kodetillegg for SAFT mva-kode 12, 1 and 81 in i [mvaKodeSAFT](https://github.com/Skatteetaten/mva-meldingen/blob/master/docs/documentation/informasjonsmodell/kodelister/mvaKodeSAFT.xml).                                                                               |
