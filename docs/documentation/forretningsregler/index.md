...
Under følger en forretingsmessig liste av regler for utfylling av mva-melding. Disse reglene er mindre detaljert enn valideringsreglene. Det er også valideringsreglene over som angir hva som faktisk er implementert.
